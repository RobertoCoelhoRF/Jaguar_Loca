...
CREATE TABLE public."Veiculo" (
    ...
    "vidroEletrico" boolean DEFAULT false NOT NULL,
    "arCondicionado" boolean DEFAULT false NOT NULL,
    cambio text DEFAULT 'MANUAL' NOT NULL,
    "travaEletrica" boolean DEFAULT false NOT NULL,
    "direcaoHidraulica" boolean DEFAULT false NOT NULL,
    "portaMalas" text DEFAULT 'MEDIO' NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    foto text,
